namespace Chemistry {
   ...
   export class Newtons_Rings extends Geometry {
    n: number;
    d: number[];
    color: string;
    canvas: HTMLCanvasElement;
    ...
    center_x: number;
    center_y: number;
    all_left_readings: number[][] = [];
    all_right_readings: number[][] = [];

    constructor(n: number, d: number[], color: string, stpt: Chemistry.Point, canvas: HTMLCanvasElement) {
        super();
        this.n = n;
        this.d = d;
        this.color = color;
   ...
   export class Line extends Geometry {
    ...
    constructor(x1: number, y1: number, x2: number, y2: number, canvas: HTMLCanvasElement) {
        super();
        this.x1 = x1;
        this.x2 = x2;
        this.y1 = y1;
