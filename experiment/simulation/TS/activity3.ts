...
function activity3() {
	...
	pp.showtitle(
		'<p id="exp-title">Newtons ring experiment to determine the wavelength of light</p>',
		3
	);
...
function load_colors() {
	let color_options: HTMLSelectElement = <HTMLSelectElement>(
		document.getElementById('color-dd')
	);
...
function set_color() {
	let color: HTMLSelectElement = <HTMLSelectElement>(
		document.getElementById('color-dd')
	);
	let r: HTMLSelectElement = <HTMLSelectElement>(
		document.getElementById('r-dd')
	);
