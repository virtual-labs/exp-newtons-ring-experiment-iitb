...
function a1_draw_all_components() {
    var sq = new Chemistry.Custome_image(circular_glass, new Chemistry.Point(1100, 800), 261 * 1.5, 46 * 1.5, canvas);
    sq.name = "Circular Glass";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(convex_lens, new Chemistry.Point(1370, 230), 68 * 1.5, 213 * 1.5, canvas);
    sq.name = "Convex Lens";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(light, new Chemistry.Point(1650, 600), 93 * 1.5, 181 * 1.5, canvas);
    sq.name = "Monochromatic Light Source";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(plano_convex, new Chemistry.Point(280, 830), 261 * 1.5, 63 * 1.5, canvas);
    sq.name = "Plano-Convex Lens";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(microscope, new Chemistry.Point(500, 380), 537 * 1.5, 414 * 1.5, canvas);
    sq.name = "Microscope";
    scene.add(sq);
}
...
{
    question = [];
    question.push({ srno: 1, question: "Select <span style='color: #018fc3'>Circular Glass</span>", ans: "Circular Glass", hint: ["Has Suction and Discharge", "Has valve attached", "Triangular Base"] });
    question.push({ srno: 2, question: "Select <span style='color: #018fc3'> Convex Lens </span>", ans: "Convex Lens", hint: ["Rectangular", "Mounted Vertically", "Has valves attached"] });
    question.push({ srno: 3, question: "Select <span style='color: #018fc3'> Monochromatic Light Source </span>", ans: "Monochromatic Light Source", hint: ["Rectangular", "Mounted Vertically", "Has valves attached"] });
    question.push({ srno: 4, question: "Select <span style='color: #018fc3'>Plano-Convex Lens</span>", ans: "Plano-Convex Lens", hint: ["Double Pipe", "pipe inside a pipe", "Has two inlets and outlets"] });
    question.push({ srno: 5, question: "Select <span style='color: #018fc3'>Travelling Microscope</span>", ans: "Microscope", hint: ["U-Shape", "Mounted horizontally", "Has two pins"] });
}
...
function load_higlighted_images() {
    ...
    a1_labels = [
        new Chemistry.Geo_Text("Circular Glass", new Chemistry.Point(1100, 800), canvas),
        new Chemistry.Geo_Text("Convex Lens", new Chemistry.Point(1370, 300), canvas),
        new Chemistry.Geo_Text("Monochromatic Light Source", new Chemistry.Point(1650, 600), canvas),
        new Chemistry.Geo_Text("Plano-Convex Lens", new Chemistry.Point(280, 830), canvas),
        new Chemistry.Geo_Text("Microscope", new Chemistry.Point(450, 90), canvas)
    ];
    a1_labels[0].font = '30%';
    a1_labels[1].font = '30%';
    a1_labels[2].font = '30%';
