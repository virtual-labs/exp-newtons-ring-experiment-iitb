function activity4() {
    ...
    pp.clearrightpannel();
    pp.addoffcanvas(3);
    pp.showtitle('<p id="exp-title">Newton’s ring experiment to determine the wavelength of light</p>', 3);
...
function verify_bright() {
    ...
    // pp.addtoleftpannel(table_2.template);
    // table_2.draw();
    pp.showdescription('<div style="background-color: #f4ccccff; border-radius: 10px; border: black; padding: 5%; font-weight: 500; font-size: calc(0.5vw + 12px);">Click Next to calculate the value of wavelength</div>', 3);
...
function complete_multi_row_table() {
    let col_1_1 = document.getElementById('ltv-0');
    let col_2_1 = document.getElementById('rtv-0');
    let col_3_1 = document.getElementById('dia-0');
    let col_1_2 = document.getElementById('ltv-1');
    let col_2_2 = document.getElementById('rtv-1');
    let col_3_2 = document.getElementById('dia-1');
    let col_1_3 = document.getElementById('ltv-2');
    let col_2_3 = document.getElementById('rtv-2');
    let col_3_3 = document.getElementById('dia-2');
    let col_1_4 = document.getElementById('ltv-3');
    let col_2_4 = document.getElementById('rtv-3');
    let col_3_4 = document.getElementById('dia-3');
    let heading_row = ['Ring Number N', 'Left MSR (0.05)', 'Left VSR (0.001)', 'Left TR', 'Right MSR (0.05)', 'Right VSR (0.001)', 'Right TR', 'Diameter'];
    let all_rows = [];
    for (let i = 0; i < 8; i++) {
        console.log('here');
